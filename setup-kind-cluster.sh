...
echo "  kubectl port-forward -n tesla-proxy service/tesla-proxy 4443:4443"
echo ""
echo "📝 Commands:"
echo "  - View logs: kubectl logs -n tesla-proxy -l app.kubernetes.io/instance=tesla-proxy"
